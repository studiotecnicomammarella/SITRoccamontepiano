...
var style_STRADARIO = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("VIA") !== null) {
        labelText = String(feature.get("VIA"));
    }
        var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(255,161,31,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 3.8}),
